...
//        }
    ...
    private static void configureWordNet() throws IOException {
        try {
            ...
            JWNL.initialize(new FileInputStream("./leakhawk-core/src/main/resources/properties.xml"));
        } catch (Exception ex) {
            ex.printStackTrace();
            System.exit(-1);
        }

        FileInputStream fstream = new FileInputStream("./leakhawk-core/src/main/resources/SriLanka.txt");
